...
Remote access to Plex is handled by Plex's own relay. All other services (Sonarr, Radarr, Seerr, etc.) are LAN-only by default.
...
| Usenet provider | `newshosting.com` | Keep credentials ready for SABnzbd |
