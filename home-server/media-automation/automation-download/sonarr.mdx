...
Both `/tv` and `/downloads` must be visible inside the container. This allows Sonarr to move files (instant rename) during import instead of copying across filesystems.
